...
{
	$to = 'seallenbury@hotmail.com';
	$subject = 'Untitled 11 Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U644"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Custom:</b></td><td>' . htmlentities($_REQUEST["custom_U658"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Custom:</b></td><td>' . htmlentities($_REQUEST["custom_U663"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Custom:</b></td><td>' . htmlentities($_REQUEST["custom_U668"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$headers = 'From:  seallenbury@hotmail.com' . "\r\n" . 'Reply-To: ' . $formEmail .  "\r\n" .'X-Mailer: Adobe Muse 7.4.30 with PHP/' . phpversion() . "\r\n" . 'Content-type: text/html; charset=utf-8' . "\r\n";
	
	$sent = @mail($to, $subject, $message, $headers);
	
	if($sent)
	{
		echo '{"FormResponse": { "success": true,"redirect":"logout.html"}}';
