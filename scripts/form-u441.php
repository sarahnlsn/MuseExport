...
function emailFormSubmission()
{
	...
	$subject = 'Untitled 9 Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U451"],ENT_COMPAT,'UTF-8') . '</td></tr>';
